                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <?php if (!empty($detail)) {
                                    ...
                                    $cate_id =  DB::table('blog_category')->where(array('id'=>$value->cat_id))->first();

                                    ?>
                                        <tr>
                                            <td class="text-center"><input type="checkbox" name="selected[]" value="<?php echo $value->id; ?>" /></td>
                                            <td class="text-left"><?= $cate_id->name; ?></td>
                                            ...
                                            <td class="text-left"><a href="<?php echo url('admin/add_blog/' . $value->id); ?>"><button type="button" class="btn btn-info"><i class="fa fa-pencil"></i>&nbsp; Edit</button></a></td>
                                        </tr>
                                <?php }
                                } ?>
                            </tbody>
