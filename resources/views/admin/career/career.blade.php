    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <a href="<?php echo url('admin/add_career'); ?>" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a> &nbsp;
                                ...
                                <?php if (!empty($detail)) {
                                    ...
                                    foreach ($detail as $key => $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-left"><?= $value->title ? $value->title :""; ?></td>
                                            <td class="text-left"><?= $value->location ? $value->location :""; ?></td>
                                            <td class="text-left"><?php echo  $value->status == 1 ? 'Active' : 'Deactive'; ?></td>
                                            <td class="text-left"><a href="<?php echo url('admin/add_career/' . $value->id); ?>"><button type="button" class="btn btn-info"><i class="fa fa-pencil"></i>&nbsp; Edit</button></a></td>
                                        </tr>
                                <?php }
                                } ?>
                            </tbody>
