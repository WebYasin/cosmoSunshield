    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                ...
                <a href="<?php echo url('admin/team'); ?>" data-toggle="tooltip" title="Cancel" class="btn btn-default"><i class="fa fa-reply"></i></a>
            </div>
                    ...
                    <div class="tab-content">
                        <div id="tab-general" class="tab-pane active">
                            <div class="form-group required">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="title" value="<?php echo old('title', $title); ?>" placeholder="Name" class="form-control" />
                                    @error('title')
                            ...
                            <div class="form-group ">
                                <label class="col-sm-2 control-label" for="input-username">Show on Top</label>
                                <div class="col-sm-10">
                                    <input type="checkbox" name="show_on_top" value="1" placeholder="" class="form-control" <?php echo $show_on_top && $show_on_top == 1 ? 'checked':''?> />
                                </div>
                            </div>
