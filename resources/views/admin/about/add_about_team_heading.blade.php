    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                ...
                <a href="<?php echo url('admin/about_team_heading'); ?>" data-toggle="tooltip" title="Cancel" class="btn btn-default"><i class="fa fa-reply"></i></a>
            </div>
                ...
                <form action="<?php echo $form_action; ?>" method="post" enctype="multipart/form-data" id="form-user" class="form-horizontal">
                    ...
                    <div class="tab-content">
                        <div id="tab-general" class="tab-pane active">
                            <legend>Group CEO's Message</legend>
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="name1" value="<?php echo old('name1', $name1); ?>" placeholder="Heading" class="form-control" />
                                    @error('name1')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="designation1" value="<?php echo old('designation1', $designation1); ?>" placeholder="Heading" class="form-control" />
                                    @error('designation1')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="form-group required">
                                <label class="col-sm-2 control-label" for="input-firstname">Message</label>
                                <div class="col-sm-10">
