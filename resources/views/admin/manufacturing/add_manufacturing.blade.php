    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                ...
                <a href="<?php echo url('admin/manufacturing'); ?>" data-toggle="tooltip" title="Cancel" class="btn btn-default"><i class="fa fa-reply"></i></a>
            </div>
                ...
                <form action="<?php echo $form_action; ?>" method="post" enctype="multipart/form-data" id="form-user" class="form-horizontal">
                    ...
                    <div class="tab-content">
                        <div id="tab-general" class="tab-pane active">
                            ...
                            <div class="form-group required">
                                <label class="col-sm-2 control-label" for="input-username">City Name</label>
                                <div class="col-sm-10">
                                    <input type="text" name="location" value="<?php echo old('location', $location); ?>" placeholder="Heading" class="form-control" />
                                    @error('location')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="form-group required">
                                <label class="col-sm-2 control-label" for="input-username">Contact Number</label>
                                <div class="col-sm-10">
                                    <input type="text" name="contact" value="<?php echo old('contact', $contact); ?>" placeholder="Heading" class="form-control" />
                                    @error('contact')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="form-group required">
                                <label class="col-sm-2 control-label" for="input-firstname">Full Address</label>
                                <div class="col-sm-10">
                                    <textarea class="form-control" name="address"><?php echo old('address', $address); ?></textarea>
