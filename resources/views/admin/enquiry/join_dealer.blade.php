                        ...
                        <table class="table table-bordered table-hover">
                            <thead>
                                ...
                                <td style="width: 1px;" class="text-center">S.No</td>
                                    ...
                                    <td class="text-left">Interested</td>
                                ...
                                <?php if (!empty($detail)) {
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-left"><?= $value->business_name; ?></td>
                                            <td class="text-left"><?= $value->business_address; ?></td>
                                            <td class="text-left"><?= $value->business_address; ?></td>
                                            <td class="text-left"><?= $value->city; ?></td>
                                            <td class="text-left"><?= $value->interest_in; ?></td>
                                            <td class="text-left"><a href="<?= url($value->image); ?>" target="_blank"><i class="fa fa-file fa-2x" aria-hidden="true"></i></a></td>
                                        </tr>
                                <?php }
                                } ?>
                            </tbody>
