                                ...
                                <?php if (!empty($detail)) {
                                    ...
                                    foreach ($detail as $key => $value) { ?>
                                        <tr>
                                            ...
                                            <td class="text-left"><a href="<?php echo url('admin/add_sustainability_heading/' . $value->id); ?>"><button type="button" class="btn btn-info"><i class="fa fa-pencil"></i>&nbsp; Edit</button></a></td>
                                        </tr>
                                <?php }
                                } ?>
                            </tbody>
