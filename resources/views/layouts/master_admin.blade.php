   ...
   <header id="header" class="navbar navbar-static-top">
    <div class="container-fluid">
     <div id="header-logo" class="navbar-header">
      <a href="<?php echo url('admin/dashboard'); ?>" class="navbar-brand"><img src="<?php echo url($config['config_logo']); ?>" alt="cyberworx" title="cyberworx" style="width: 78%;    margin-top: -27px;" /></a>
     </div>
