                ...
                <div class="social">
                    ...
                    <a href="<?php echo $wconfig['config_facebook']; ?>" target="_blank">
                        <svg width="13" height="23" viewBox="0 0 13 23" fill="none"
                            ...
                            <path
                                d="M10.673 3.82h2.188V.162A29.42 29.42 0 0 0 9.674 0C6.52 0 4.36 1.904 4.36 5.405v3.222H.878v4.09H4.36V23h4.267V12.716h3.34l.53-4.089h-3.87V5.811c0-1.177.331-1.991 2.046-1.991Z"
                                fill="#fff" />
                        </svg>
                    </a>
                    <?php } ?>
                    ...
                    <?php if($wconfig['config_youtube']){ ?>
                        ...
                        <svg width="29" height="20" viewBox="0 0 29 20" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M28.125 3.372A3.523 3.523 0 0 0 25.65.895C23.456.292 14.67.292 14.67.292 11 .25 7.332.442 3.687.872a3.587 3.587 0 0 0-2.472 2.5 37.163 37.163 0 0 0-.579 6.761c-.014 2.267.18 4.53.579 6.76a3.523 3.523 0 0 0 2.474 2.478c2.22.602 10.982.602 10.982.602 3.67.043 7.338-.15 10.983-.58a3.517 3.517 0 0 0 2.47-2.476 37.1 37.1 0 0 0 .58-6.76 35.272 35.272 0 0 0-.58-6.785Z"
                                fill="#fff" />
                    ...
                    <?php if($wconfig['config_linkedin']){ ?>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="29" height="29" viewBox="0 0 100 100"
